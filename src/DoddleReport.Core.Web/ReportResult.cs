    ...
    public class ReportResult : ActionResult
    {
        ...
        public override void ExecuteResult(ActionContext context)
        {
            ...
            if (!string.IsNullOrEmpty(FileName))
            {
                ...
                context.HttpContext.Response.Headers.Add("content-disposition", string.Format("attachment; filename={0}{1}", FileName, extension));
            }
        ...
        private static WriterElement GetWriterFromExtension(ActionContext context, string defaultExtension)
        {
